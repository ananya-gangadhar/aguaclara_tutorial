...
print(len(fib))
fib_a = np.array(fib)
fib_am = u.Quantity(fib_a,u.m)

agentp = np.array([[1,2,3,4,5],[2,4,6,8,10],[3,6,9,12,15],[4,8,12,16,20],[5,10,15,20,25]])

mid_agentp = np.array([agentp[:,2],agentp[:,3]])
mid_agentp_l = u.Quantity(mid_agentp,u.l)
